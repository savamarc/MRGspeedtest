...
int64_t __MRG32k3a_s10, __MRG32k3a_s11, __MRG32k3a_s12, __MRG32k3a_s20, __MRG32k3a_s21, __MRG32k3a_s22;

void init(void) {
  srand(time(NULL));
  __MRG32k3a_s10 = rand()%4294967087;
  __MRG32k3a_s11 = rand()%4294967087;
  __MRG32k3a_s12 = rand()%4294967087;
  __MRG32k3a_s20 = rand()%4294944443;
  __MRG32k3a_s21 = rand()%4294944443;
  __MRG32k3a_s22 = rand()%4294944443;
}
